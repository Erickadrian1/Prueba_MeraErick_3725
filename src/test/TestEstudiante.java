...
public class TestEstudiante {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Listado de Estudiantes ordenados de mayor a menor nota");//Imprimo la funcion ordenarMayorMenor 
        ordenarMayorMenor(estudiantes,n);
        //llamar al metodo para ordenar de mayor a menor 
        for(Estudiante est:estudiantes){
            System.out.println(est);
        }
        
        System.out.println("Listado de Estudiantes ordenados de menor a mayor nota");//Imprimo la funcion ordenar MenorMayor
        ordenarMenorMayor(estudiantes,n);
        //llamar al metodo para ordenar de menor a mayor 
        for(Estudiante est:estudiantes){
            System.out.println(est);
        }
    ...
    //Al haber realizado el ordenamiento de mayor a menor podemos proceder a realizar de menor a mayor 
